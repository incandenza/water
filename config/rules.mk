...
ifndef OBJS
OBJS			= $(JRI_STUB_CFILES) $(addsuffix .o, $(JMC_GEN)) $(CSRCS:.c=.o) $(CPPSRCS:.cpp=.o) $(ASFILES:.s=.o) $(EXTRA_OBJS)
endif
...
define MAKE_OBJDIR
if test ! -d $(@D); then rm -f $(@D); $(NSINSTALL) -D $(@D); fi
endef
endif
...
realclean clobber_all::
	rm -rf $(wildcard *.OBJ) dist $(ALL_TRASH) $(EXTRA_TRASH) $(wildcard *~) $(wildcard #*#) TAGS
	+$(LOOP_OVER_DIRS)
